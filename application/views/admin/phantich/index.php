<div class="body chart">
	<ul class="clearfix">
		<li class="leftColumn">
			<ul>
				<li style="display: none;" id="_msgId" class="msgContainer"></li>
				<li id="_contentBlock"><ul class="box">
	<li class="boxTitle"><h3>Phân Tích Kỹ Thuật</h3></li>
	<li class="boxContent"><input id="financeChart_JsChartViewerState" name="financeChart_JsChartViewerState" value="24**" type="hidden"><input id="financeChart_callBackURL" name="financeChart_callBackURL" value="/index.php?cdLoopBack=1" type="hidden"><img id="financeChart" src="giaodich_files/getchart.png" border="0">
		...
		<li class="rightColumn">
			<div class="clearfix">
	<ul class="gameAction">
			<li class="joinGame"><a href="http://vnstockgame.com/emoney/active" onclick="ajaxFixer.fixLink(this,{reload:true})">Kích hoạt vòng chơi</a></li>
			<li class="recharge"><a href="http://vnstockgame.com/emoney/recharge" onclick="ajaxFixer.fixLink(this,{reload:true})">Nạp tiền ảo</a></li>
	</ul>
</div>			<ul>
				<li class="boxCorner marginB20"><form id="frmFinanceChart" name="frmFinanceChart" action="" method="post" onsubmit="return false;">
<ul class="financeChartParams">
	<li class="label">Mã chứng khoán</li>
	<li><select name="symbol"><option label="AAA" value="AAA">AAA</option>
...
<option selected="selected" label="AGM" value="AGM">AGM</option>
...
<option label="YBC" value="YBC">YBC</option>
	...
	<li class="label">Khoản thời gian</li>
	<li><select name="timePeriod"><option label="7 ngày" value="7">7 ngày</option>
<option label="15 ngày" value="15">15 ngày</option>
<option label="1 tháng" value="30">1 tháng</option>
<option label="2 tháng" value="60">2 tháng</option>
<option label="3 tháng" value="90">3 tháng</option>
<option selected="selected" label="6 tháng" value="180">6 tháng</option>
<option label="1 năm" value="360">1 năm</option>
<option label="2 năm" value="720">2 năm</option>
<option label="3 năm" value="1080">3 năm</option>
<option label="4 năm" value="1440">4 năm</option>
<option label="5 năm" value="1800">5 năm</option>
</select></li>
	<li class="label">Loại biểu đồ</li>
	<li><select name="chartType"><option label="None" value="N">None</option>
<option label="CandleStick" value="CS">CandleStick</option>
<option label="Closing Price" value="CP">Closing Price</option>
<option label="Median Price" value="MP">Median Price</option>
<option label="OHLC" value="OHLC">OHLC</option>
<option selected="selected" label="Typical Price" value="TP">Typical Price</option>
<option label="Weighted Close" value="WC">Weighted Close</option>
</select></li>
	<li class="label">Price Band</li>
	<li><select name="priceBand"><option label="None" value="N">None</option>
<option label="Bollinger Band" value="BB" selected="selected">Bollinger Band</option>
<option label="Donchian Channel" value="DC">Donchian Channel</option>
<option label="Envelop (SMA 20 +/- 10%)" value="E">Envelop (SMA 20 +/- 10%)</option>
</select></li>
	<li class="label">Moving Averages</li>
	<li>
		<div>
			<ul class="clearfix">
				<li><select name="avgType1"><option label="None" value="N">None</option>
<option label="Simple" value="SMA">Simple</option>
<option label="Exponential" value="EMA">Exponential</option>
<option label="Triangular" value="TMA">Triangular</option>
<option selected="selected" label="Weighted" value="WMA">Weighted</option>
</select></li>
				<li><input name="movAvg1" value="5" maxlength="3" class="input" onkeyup="Utility.inputMask(this,'0-9')" type="text"></li>
			</ul>
		</div>
		<div>
			<ul class="clearfix">
				<li><select name="avgType2"><option label="None" value="N">None</option>
<option label="Simple" value="SMA">Simple</option>
<option selected="selected" label="Exponential" value="EMA">Exponential</option>
<option label="Triangular" value="TMA">Triangular</option>
<option label="Weighted" value="WMA">Weighted</option>
</select></li>
				<li><input name="movAvg2" value="25" maxlength="3" class="input" onkeyup="Utility.inputMask(this,'0-9')" type="text"></li>
			</ul>
		</div>
	</li>	
	<li class="label">Technical Indicators</li>
	<li><select name="indicator1"><option label="None" value="N">None</option>
<option label="Accumulation/Distribution" value="AccDist">Accumulation/Distribution</option>
<option label="Aroon Oscillator" value="AroonOsc">Aroon Oscillator</option>
<option label="Aroon Up/Down" value="Aroon">Aroon Up/Down</option>
<option label="Avg Directional Index" value="ADX">Avg Directional Index</option>
<option label="Avg True Range" value="ATR">Avg True Range</option>
<option label="Bollinger Band Width" value="BBW">Bollinger Band Width</option>
<option label="Chaikin Money Flow" value="CMF">Chaikin Money Flow</option>
<option label="Chaikin Oscillator" value="COscillator">Chaikin Oscillator</option>
<option label="Chaikin Volatility" value="CVolatility">Chaikin Volatility</option>
<option label="Close Location Value" value="CLV">Close Location Value</option>
<option label="Commodity Channel Index" value="CCI">Commodity Channel Index</option>
<option label="Detrended Price Osc" value="DPO">Detrended Price Osc</option>
<option label="Donchian Channel Width" value="DCW">Donchian Channel Width</option>
<option label="Ease of Movement" value="EMV">Ease of Movement</option>
<option label="Fast Stochastic" value="FStoch">Fast Stochastic</option>
<option label="MACD" value="MACD" selected="selected">MACD</option>
<option label="Mass Index" value="MDX">Mass Index</option>
<option label="Momentum" value="Momentum">Momentum</option>
<option label="Money Flow Index" value="MFI">Money Flow Index</option>
<option label="Neg Volume Index" value="NVI">Neg Volume Index</option>
<option label="On Balance Volume" value="OBV">On Balance Volume</option>
<option label="Performance" value="Performance">Performance</option>
<option label="% Price Oscillator" value="PPO">% Price Oscillator</option>
<option label="% Volume Oscillator" value="PVO">% Volume Oscillator</option>
<option label="Pos Volume Index" value="PVI">Pos Volume Index</option>
<option label="Price Volume Trend" value="PVT">Price Volume Trend</option>
<option label="Rate of Change" value="ROC">Rate of Change</option>
<option label="RSI" value="RSI">RSI</option>
<option label="Slow Stochastic" value="SStoch">Slow Stochastic</option>
<option label="StochRSI" value="StochRSI">StochRSI</option>
<option label="TRIX" value="TRIX">TRIX</option>
<option label="Ultimate Oscillator" value="UO">Ultimate Oscillator</option>
<option label="Volume" value="Vol">Volume</option>
<option label="William's %R" value="WilliamR">William's %R</option>
</select></li>
	<li><select name="indicator2"><option label="None" value="N">None</option>
<option label="Accumulation/Distribution" value="AccDist">Accumulation/Distribution</option>
<option label="Aroon Oscillator" value="AroonOsc">Aroon Oscillator</option>
<option label="Aroon Up/Down" value="Aroon">Aroon Up/Down</option>
<option label="Avg Directional Index" value="ADX">Avg Directional Index</option>
...
<option label="Ease of Movement" value="EMV">Ease of Movement</option>
<option label="Fast Stochastic" value="FStoch">Fast Stochastic</option>
<option label="MACD" value="MACD">MACD</option>
<option label="Mass Index" value="MDX">Mass Index</option>
<option label="Momentum" value="Momentum">Momentum</option>
<option label="Money Flow Index" value="MFI" selected="selected">Money Flow Index</option>
<option label="Neg Volume Index" value="NVI">Neg Volume Index</option>
<option label="On Balance Volume" value="OBV">On Balance Volume</option>
<option label="Performance" value="Performance">Performance</option>
<option label="% Price Oscillator" value="PPO">% Price Oscillator</option>
...
<option label="William's %R" value="WilliamR">William's %R</option>
	...
	<li><select name="indicator3"><option label="None" value="N">None</option>
<option label="Accumulation/Distribution" value="AccDist">Accumulation/Distribution</option>
<option label="Aroon Oscillator" value="AroonOsc">Aroon Oscillator</option>
<option label="Aroon Up/Down" value="Aroon">Aroon Up/Down</option>
<option label="Avg Directional Index" value="ADX">Avg Directional Index</option>
...
<option label="MACD" value="MACD">MACD</option>
<option label="Mass Index" value="MDX">Mass Index</option>
<option label="Momentum" value="Momentum" selected="selected">Momentum</option>
<option label="Money Flow Index" value="MFI">Money Flow Index</option>
<option label="Neg Volume Index" value="NVI">Neg Volume Index</option>
<option label="On Balance Volume" value="OBV">On Balance Volume</option>
<option label="Performance" value="Performance">Performance</option>
...
<option label="William's %R" value="WilliamR">William's %R</option>
	...
	<li><select name="indicator4"><option label="None" value="N">None</option>
<option label="Accumulation/Distribution" value="AccDist">Accumulation/Distribution</option>
<option label="Aroon Oscillator" value="AroonOsc">Aroon Oscillator</option>
<option label="Aroon Up/Down" value="Aroon">Aroon Up/Down</option>
<option label="Avg Directional Index" value="ADX">Avg Directional Index</option>
...
<option label="Price Volume Trend" value="PVT">Price Volume Trend</option>
<option label="Rate of Change" value="ROC">Rate of Change</option>
<option label="RSI" value="RSI" selected="selected">RSI</option>
<option label="Slow Stochastic" value="SStoch">Slow Stochastic</option>
<option label="StochRSI" value="StochRSI">StochRSI</option>
<option label="TRIX" value="TRIX">TRIX</option>
<option label="Ultimate Oscillator" value="UO">Ultimate Oscillator</option>
...
<option label="William's %R" value="WilliamR">William's %R</option>
	...
	<li class="paddingT10 alignCenter"><input value="Cập Nhật Biểu Đồ" class="btnMedium" style="width:150px" onclick="App.ajaxLoad('chart/finance/update/1/'+Utility.createUrl('frmFinanceChart', 'symbol,timePeriod,chartType,priceBand,avgType1,movAvg1,avgType2,movAvg2,indicator1,indicator2,indicator3,indicator4', '/'))" type="button"></li>
</ul>
</form></li>
