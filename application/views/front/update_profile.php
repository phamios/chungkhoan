...
<ul>
	...
	<li id="_contentBlock"><ul class="boxYellow">
			<li class="boxTitle"><h3>Cập nhật</h3></li>
			<li class="boxContent"> 
			...
			<?php echo form_open_multipart('home/register',array('id'=>'frmRegister' )); ?>
							...
							<tbody>
								<tr>
									...
									<td><input id="username" name="username" 
										...
										type="text" value="<?php echo $member->member_name?>"></td>
								</tr>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td><input name="full_name"  maxlength="50"
										class="inputBig" type="text" value="<?php echo $member->member_fullname?>"></td>
								</tr>
								<tr>
									<td class="textRequiredField">Giới tính</td>
									<td>
										<input name="gender" value="0" <?php if($member->member_sex == 0): ?> checked="checked"<?php endif;?>
											type="radio">Nam&nbsp;
										 <input name="gender" value="1"  <?php if($member->member_sex ==1): ?> checked="checked"<?php endif;?>
											type="radio">Nữ
									</td>
								</tr>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td><input name="email"  maxlength="128"
										class="inputBig" type="text" value="<?php echo $member->member_email?>"></td>
								</tr>
								<tr>
									<td class="textRequiredField">ĐTDĐ</td>
									<td><input name="phone"  maxlength="40"
										class="inputBig" type="text"  value="<?php echo $member->member_phone?>"></td>
								</tr>
								<tr>
									<td class="textRequiredField">Địa chỉ</td>
									<td><input name="mem_address"  maxlength="200"
										class="inputBig" type="text" value="<?php echo $member->member_address?>"></td>
								</tr>
								<tr>
									<td></td>
									<td class="note">- VD: 0987016811 (không được nhập 84 phía
					...
					<input  value="Cập nhật" name="update_submit" id="update_submit" class="btnYellow" style="margin-right: 10px;" type="submit"/>
