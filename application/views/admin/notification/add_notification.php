         ...
         <div class="span12">
             <div class="box dark">
                 ...
                 <div id="div-1" class="accordion-body collapse in body">
                        ...
                        <?php echo form_open_multipart('admincp/notification/add_notification',array('class'=>'form-horizontal')); ?>
                         ...
                         <div class="control-group">
                             <label for="text1" class="control-label">Link liên quan</label>
