	...
	<li id="_contentBlock"><ul class="boxYellow">
			...
			<li class="boxContent">
				<div class="tooltipLogin">
					Nếu bạn đã có tài khoản trên <strong><span
						style="text-transform: uppercase;" id="d43v7uu0160_1"
						class="d43v7uu0160">vnstockgame</span>.com</strong>? Vui lòng <a
						href="http://www.vnstockgame.com/account" >Nhấn vào đây</a> để đăng nhập.
				</div>
				<div class="tooltipLogin">
					<?php if(isset($error)):?>
						<?php echo $error;?>
